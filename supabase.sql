...
create table if not exists loads (
  ...
  origin_load_date date,
  origin_broker text,
  origin_load_number text,
  return_load_date date,
  return_broker text,
  return_load_number text,
...
alter table loads add column if not exists origin_load_date date;
alter table loads add column if not exists origin_broker text;
alter table loads add column if not exists origin_load_number text;
alter table loads add column if not exists return_load_date date;
alter table loads add column if not exists return_broker text;
alter table loads add column if not exists return_load_number text;
