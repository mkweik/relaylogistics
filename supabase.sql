...
alter table loads add column if not exists origin_driver_location text;
alter table loads add column if not exists origin_pickup_location text;
alter table loads add column if not exists origin_delivery_location text;
alter table loads add column if not exists return_driver_location text;
alter table loads add column if not exists return_pickup_location text;
alter table loads add column if not exists return_delivery_location text;
alter table loads add column if not exists origin_total_miles numeric default 0;
alter table loads add column if not exists return_total_miles numeric default 0;
